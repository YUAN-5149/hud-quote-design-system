...
import { CASES_SEED } from './lib/data.js';
...
export default function App() {
  ...
  const [cases, setCases] = usePersistedState('hud_cases_v1', CASES_SEED);
  ...
  const content = () => {
    switch (screen) {
      case 'dashboard': return <Dashboard cases={cases} onOpenCase={openCase} onNewCase={() => setNewCaseOpen(true)} onBuildQuote={openNewQuote} />;
      ...
      case 'billing': return <BillingScreen cases={cases} />;
