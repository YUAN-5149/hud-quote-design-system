  ...
  return (
    <div className="screen" data-screen-label="Materials">
      ...
      <Panel title={`CATALOG · ${filtered.length} SKUS`} meta="LIVE">
        ...
        <table className="data-table">
          <thead>
            <tr><th>CODE</th><th style={{ fontSize: "12px" }}>品名</th><th>類別</th><th>單位</th><th style={{ textAlign: 'right' }}>單價</th><th style={{ textAlign: 'right' }}>庫存</th><th style={{ textAlign: 'right' }}>庫存值</th></tr>
          </thead>
          <tbody>
            {filtered.map((m) => {
